...
export function SourceTargetSelector({
  ...
  return (
    <Card className="w-full rounded-2xl shadow-sm border border-border bg-muted/20">
      ...
      <CardContent className="grid md:grid-cols-2 gap-6">
        <div className="space-y-2">
          ...
          <Select value={source} onValueChange={onSourceChange}>
            <SelectTrigger
              id="source"
              className="w-full bg-gray-200 border border-border px-3 py-2 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary/40"
            >
